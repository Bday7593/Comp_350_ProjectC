...
;2019
;
;This is a simple bootloader that loads and executes a
;kernel at sector 3
...
KSTART	equ 3	;kernel lives at sector 3
	...
	;read in the kernel from the disk
		...
		mov al, KSIZE	;read from KSIZE sectors
	...
	;aa55 tell the BIOS that this is a valid bootloader
	dw 0xAA55